...
const pathBack = "http://localhost:3000/api/";
...
export class UserService {
  ...
  getUsers() {
    return this.http.get<User[]>("http://localhost:3000/api/mock/users");
  }
  getUser(id) {
    return this.http.get<User[]>(`http://localhost:3000/api/users/${id}`);
  }
  // attachTraining(id) {
  //   return this.http.put<User[]>(`http://localhost:3000/api/attach/${id}`);
  // }
  ...
  getCurrentUser(id) {
    return this.http.get<User>(`http://localhost:3000/api/currentUser/${id}`);
  }
  getAllUsers() {
